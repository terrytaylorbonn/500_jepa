...
# =========================
# --- D56-C CHANGE ---
# ASCII visualization upgrades:
#  - Track center char still A/B (or a/b)
#  - Add a "halo" around tracks to show:
#       UPDATE vs COAST (mode)
#       LOW/MID/HIGH uncertainty (size/shape)
#
#  Halo rules (only drawn on '.' cells, never overwrites truth/obstacles/robot):
#   UPDATE + LOW  : '+' at 4-neighbors
#   UPDATE + MID  : '+' at 8-neighbors
#   UPDATE + HIGH : '+' at distance-2 cross
#
#   COAST  + LOW  : ':' at 4-neighbors
#   COAST  + MID  : ':' at 8-neighbors
#   COAST  + HIGH : ':' at distance-2 cross
#
#  This makes it easy to SEE coasting + uncertainty growth.
# =========================
