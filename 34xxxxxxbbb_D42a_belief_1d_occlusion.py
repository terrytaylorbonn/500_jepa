...
# def plot_world_and_belief(world: World1D, belief: Belief1D, t: int, observation: Optional[int]):
#     if plt is None:
#         return
...
#     # Mark wall
#     row[world.wall_idx] = 3
#     # Mark object
#     row[world.object_idx] = 2
#     # Mark robot
#     row[world.robot_idx] = 1
...
#         plt.ion()
    ...
    for t in range(num_steps):
        ...
        # # 6) Plot
        # if plot and plt is not None:
        #     plot_world_and_belief(world, belief, t, obs)
